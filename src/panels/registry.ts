...
export const PANEL_REGISTRY: PanelMeta[] = [
  ...
  // ── Workspace harness (Discord-connected dev workspace) ────────────
  // Per-user access to the harness daemon via the awkit-backend
  // workspace_harness router — NOT the daemon's own shared bearer.
  {
    id: 'sessions',
    name: 'Sessions',
    description: 'Shared Claude Code / terminal sessions — create, steer, and watch agent runs',
    category: 'infrastructure',
    icon: 'terminal',
    apiPrefix: '/api/workspace/harness',
    domain: 'workspace',
  },
  {
    id: 'terminal',
    name: 'Terminal',
    description: 'Live PTY terminal into a workspace session (xterm + stream)',
    category: 'infrastructure',
    icon: 'command',
    apiPrefix: '/api/workspace/harness',
    domain: 'workspace',
  },
  {
    id: 'sandbox',
    name: 'Sandboxes',
    description: 'Isolated dev sandboxes — create, share, and run sessions inside them',
    category: 'infrastructure',
    icon: 'box',
    apiPrefix: '/api/workspace/harness',
    domain: 'workspace',
  },
  {
    id: 'discord',
    name: 'Discord Server',
    description: 'The bound Discord server — channels, recent messages, reply in-channel as Aither',
    category: 'integrations',
    icon: 'message-square',
    apiPrefix: '/api/workspace/discord',
    domain: 'workspace',
  },
  {
    id: 'batch-upload',
  ...
  // The three below each had a COMPONENT in DynamicPanelRenderer and no entry
  // here (RB021, measured 2026-09-21), so nothing could offer them: the tenant
  // front door shipped its two panels on 09-18 and the gym panel earlier, and
  // every one was reachable by nothing.
  {
    id: 'access-policy',
    name: 'Access & Sign-in',
    description: 'Which doors the workspace front door offers on the lock screen',
    category: 'admin',
    icon: 'door-open',
    apiPrefix: '/api/gate',
    planRequirement: 'free',
  ...
  },
  {
    id: 'door-people',
    name: 'Who Gets In',
    description: 'Invitations, grants and the front door history',
    category: 'admin',
    icon: 'users',
    apiPrefix: '/api/gate',
    planRequirement: 'free',
  ...
  {
    id: 'volunteer-compute',
    name: 'Volunteer Compute',
    description: 'Contribute CPU to embed Reddit comments, earn tokens, view roster and reputation',
    category: 'infrastructure',
    icon: 'cpu',
    apiPrefix: '/api/volunteer',
